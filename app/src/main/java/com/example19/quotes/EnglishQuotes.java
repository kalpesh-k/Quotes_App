...
public class EnglishQuotes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final  String s3 = "\"The greatest glory in living lies not in never falling, but in rising every time we fall.\"";
        q3.setText(s3);

        q4 = findViewById(R.id.q4);
        final  String s4 = "Your time is limited, so don't waste it living someone else's life. Don't be trapped by dogma – which is living with the results of other people's thinking.\"";
        q4.setText(s4);
    }
}
